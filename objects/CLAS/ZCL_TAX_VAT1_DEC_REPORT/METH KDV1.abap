  METHOD kdv1.
    ...
    DATA lv_oran_009 TYPE ztax_ddl_i_vat1_dec_report-oran.

    DATA lv_oran_009_num TYPE i.

    DATA lv_matrah_009 TYPE ztax_ddl_i_vat1_dec_report-matrah.
      ...
      CASE ls_map-kural.
        ...
        WHEN '001' OR '003' OR '005'.
          ...
          IF ls_map-saknr IS NOT INITIAL.
            ...
            LOOP AT lt_bset INTO ls_bset WHERE mwskz EQ ls_map-mwskz.
              ...
              CHECK lv_ita_skip EQ abap_false.
        ...
        WHEN '009'.
          ...
          LOOP AT lt_bset_009 INTO ls_bset.
            ...
            IF lv_oran_009_num IS NOT INITIAL.

              lv_matrah_009 = ls_bset-hwbas * 100 / lv_oran_009_num.
            ...
            ls_collect-oran   = lv_oran_009.

            ls_collect-matrah = lv_matrah_009.
